package cn.edu.nuc.spring.util.page;
...
public class PageUtil implements Page {
    ...
    public static PageBean getPageBean(PageUtil puc) {
        ...
        pb.setLastPageNumber(puc.getLastPageNumber());
        ...
        pb.setThisPageNumber(puc.getThisPageNumber());
        pb.setTotalNumberOfElements(puc.getTotalNumberOfElements());
        pb.setThisPageElements((List<Object>) puc.getThisPageElements());
        return pb;
    }
