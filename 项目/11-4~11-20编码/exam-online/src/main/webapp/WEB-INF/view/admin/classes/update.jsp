...
<div class="admin">
     <form id="classes_update_form" method="post" action="admin/classes/doUpdate">
                    <input type="hidden" name="claid" value="${classes.claid}">
                    <div class="form-group"><div class="label">
                    <label>班级名称</label>
                    </div>
                    <div class="field">
                    <input type="text" class="input" name="claname" maxlength="50" value="${classes.claname}" data-validate="required:请填写内容" placeholder="请填写用户名">
                            </div>
                            </div>
                    <div class="form-group"><div class="label">
                    <label>所属专业</label>
                            ...
                            <select name="dept.deptid">
                               ...
                               <c:forEach items="${deptLists}" var="dept">
                                 <option value="${dept.deptid}"
                                    <c:if test='${dept.deptid==classes.deptid}'>selected</c:if>
...
<div class="hidden">
		    ...
		    $(document).ready(function(){
				$('#classes_update_form').bind('submit', function(){
